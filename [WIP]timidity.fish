#Options:
#  -A n,m                                -d "Amplify volume and drum power     "
# --volume=n                             -d "Amplify volume"
# --drum-power=m                         -d "Amplify drum power"
#     (a)     --[no-]volume-compensation Toggle amplify compensation (disabled by default)
# -s a 
# -l anti-alias                  -d "Enable the anti-aliasing filter"
# -l no-anti-alias               -d "Disable the anti-aliasing filter"
# -s B -l buffer-fragments=n,m n,m         -d "Set number of buffer fragments and buffer size"
# -s C -l control-ratio=                   -d "Set ratio of sampling and control frequencies"
# -s c -l config-file=         file        -d "Read extra configuration file"
# -s D -l drum-channel=        n           -d "Play drums on specified channel"
# -s d -l interface-path=      path        -d "Set dynamic interface module directory"
# -s E -l ext=mode             mode        
...
#                   default: -E wpvSEToz
#  -F         --[no-]fast-panning Disable/Enable fast panning (toggle on/off, default is on)
#  -f         --[no-]fast-decay
...
#  -g sec     --spectrogram=sec Open Sound-Spectrogram Window
#  -H n       --force-keysig=n
